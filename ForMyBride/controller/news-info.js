...
app.factory("newsF", function(){
    ...
    Articles["TonyaFriends"] = {
        ...
        SecondFriendBoy: "Теперь речь пойдет о другом Тонином однокласснике, его зовут Гоша. Они с Тоней и Пашей играют в оркестре гармоник. В целом, Гоша, обычный " +
        "парень, работает в тур-агенстве, отправляет людей тусоваться и сам тусуется! Я всегда, когда хожу на Тонины концерты и смотрю как играет Гоша, это, что-то неповторимое." +
        " Я не слышу, именно его игру так как играет целый оркестр, но его мимика и движения, это целое представление, и это еще и выглядит очень эргономично. Это все, что я могу сказать" +
        "про Гошу.",
        ThirdFriendBoy: "Сейчас речь пойдет о том самом Вадиме, который раньше Тоне очень нравился. Они познакомились в оркестре, ну и " +
        ...
        FourFriendBoy: "Тут вы может быть удивитесь, а может и нет, но четвертым близким другом я назову одного из своих лючших друзей. А именно" +
    ...
    Articles["TonyaUniversity"] = {
        Title : "Студенческая пора",
        Body : "Вот мы и добрались до университета! Для меня это были очень интересные годы, а вот для Тонечки это уже скорее обыденность, чем, что-то особенное. Тонечка сейчас учится" +
        "в университете 'Технологии и дизайна' на факультете химии и экологии, и она за первый курс уже успела поработать и уйти из экологической компании, а также разочаровалась в этой" +
        "профессии и специальности. Как оказалось в нашей стране экологи занимаются только тупым заполнением бумаги, и нет организованы никакие органы контроля за предприятиями, которые бы " +
        "котролировали и принуждали выполнять регламенты по экологической деятельности. Конечно, я, вероятнее всего сейчас много напутал, но в любом случае, в нашей стране эколог - это не пристижно" +
        "и не развито, видимо когда мы будем задыхаться от смога, блевать от ядовитого воздуха, ходить по колено в мусоре и травиться от всех выращенных продуктов и пойманных(выращенных) животных" +
        "для пищи, тогда и будем думать как с этим бороться. Ну да ладно, не будем о грустном. Тоня решила доучиться в университете, чтобы было высшее образование, и она всегда доводит дела до" +
        "конца, и поэтому раз уж поступила, значит закончит."
    };

    Articles["TonyaAndNature"] = {
        Title : "Немного о нашей животной природе",
        Body : "Я думаю все понимают, что люди это животные наделенные интелектом, но мы все равно классифицируем себя в класс-млекопитающих, отряд-приматов, семейство-гоминид и вид-люди(homo). Ну " +
        "если точно мы - 'Человек разумный'. Так вот, раз мы все равно животные, у каждого из нас есть некоторое стремление к природе, и натуралистичности. В целом у людей это проявляется разными" +
        "способами: походы, путешествия, дача, экспедиции, так или иначе, но люди любят бывать на природе, но не все! Моя Тонечка конечно природу любит, все-таки на эколога учится, но тем не менее " +
        "ее очень трудно куда-нибдудь выманить, потому что она жуткая трусиха! Она боится всех букашек которые живут в траве, боится змей, диких животных, и почти всего что есть в лесу. Это конечно " +
        "обосновано, так как все это таит в себе опасность, но она после последнего нашего разговора о букашках, даже на дачу не хочет теперь ездить. Ну я надеюсь, что я смогу это со временем изменить " +
        "ее отношении к природе, но если нет, значит будет ездить со мной в лес с максимальной, гермитичной защитой! Вот летом летим в Абхазия, там ей все-таки придется гулять со мной по горам и рекам, и" +
        " в море плавать будет!!)Уже неплохо!)"
    };
